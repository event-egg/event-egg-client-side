  ...
  render() {
    return (
      <div>
        ...
        <Navbar.Brand className='me-auto d-inline-flex justify-content-center'  style={{fontSize: '1.5em'}}>
        <Link to="/" className='me-auto d-inline-flex align-items-center mx-0'>
              <Image
                alt=""
            ...
            <Container className='me-auto d-inline-flex align-items-center mb-2'>
              Event Egg
            </Container>
          </Navbar.Brand>
