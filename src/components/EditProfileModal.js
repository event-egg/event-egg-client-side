          ...
          <Modal.Body>
            <Form onSubmit={this.handleProfileSubmit}>
              ...
              <Row xs={2}>
                ...
                <Col className='text-center'>
                  <Button className='mx-3 px-5' variant="outline-secondary" style={{ backgroundColor: "#90dbf4", fontSize: '1.4em', fontWeight: 'bold'}} className="mx-1" variant="secondary" onClick={() => this.props.closeModal('profile')}>Close</Button>
                </Col>
              </Row>
            </Form>
          </Modal.Body>
